...
$_LANG['shop_price'] = '国外售价：';
$_LANG['market_price'] = '国内售价：';
...
$_LANG['goods_bonus'] = '购买此商品可获得奖励积分：';
...
$_LANG['use_bonus'] = '使用奖励积分';
$_LANG['use_bonus_kill'] = '使用线下奖励积分';
$_LANG['invoice'] = '开发票';
...
$_LANG['top10'] = '销售排行';
/* 外币价格字段 */
$_LANG['foreign_currency'] = '外币价格';
$_LANG['origin_currency'] = '人民币价格';
$_LANG['foreign_currency_GBP'] = "£%s";
$_LANG['foreign_currency_USD'] = "$%s";
$_LANG['foreign_currency_CAD'] = "C$%s";
$_LANG['foreign_currency_EUR'] = "€%s";
$_LANG['foreign_currency_JPY'] = "円%s";
$_LANG['foreign_currency_AUD'] = "AU$%s";
$_LANG['foreign_currency_HKD'] = "HK$%s";
$_LANG['auto_delivery'] = "自动发货";
$_LANG['shop_delivery'] = "闪电发货";
$_LANG['delivery_method'] = "发货类型：";
?>