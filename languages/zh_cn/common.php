...
$_LANG['foreign_currency_GBP'] = "£%s英镑";
$_LANG['foreign_currency_USD'] = "$%s美元";
$_LANG['foreign_currency_CAD'] = "$%s加元";
$_LANG['foreign_currency_EUR'] = "€%s欧元";
$_LANG['foreign_currency_JPY'] = "¥%s日元";
$_LANG['foreign_currency_AUD'] = "$%s澳元";
$_LANG['foreign_currency_HKD'] = "$%s港元";
?>