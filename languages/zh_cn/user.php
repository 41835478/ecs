 ...
 * ============================================================================
 * $Author: wangleisvn $
 * $Id: user.php 15924 2009-05-07 06:46:34Z wangleisvn $
*/
...
$_LANG['user_bonus'] = '用户奖励积分';
$_LANG['user_bonus_info'] = '共计 %d 个,价值 %s';
$_LANG['not_bonus'] = '没有奖励积分';
$_LANG['add_user_bonus'] = '添加一个奖励积分';
$_LANG['bonus_number'] = '奖励积分序列号';
$_LANG['old_password'] = '原密码';
$_LANG['new_password'] = '新密码';
$_LANG['confirm_password'] = '确认密码';

$_LANG['bonus_sn_exist'] = '此奖励积分号码已经被占用了！';
$_LANG['bonus_sn_not_exist'] = '此奖励积分号码不存在！';
$_LANG['add_bonus_sucess'] = '添加新的奖励积分操作成功！';
$_LANG['add_bonus_false'] = '添加新的奖励积分操作失败！';
...
//JS语言项
$_LANG['profile_js']['bonus_sn_empty'] = '请输入您要添加的奖励积分号码！';
$_LANG['profile_js']['bonus_sn_error'] = '您输入的奖励积分号码格式不正确！';
...
/* 会员奖励积分 */
$_LANG['bonus_is_used'] = '你输入的奖励积分你已经领取过了！';
$_LANG['bonus_is_used_by_other'] = '你输入的奖励积分已经被其他人领取！';
$_LANG['bonus_add_success'] = '您已经成功的添加了一个新的奖励积分！';
$_LANG['bonus_not_exist'] = '你输入的奖励积分不存在';
$_LANG['user_bonus_empty'] = '您现在还没有奖励积分';
$_LANG['add_bonus_sucess'] = '添加新的奖励积分操作成功！';
$_LANG['add_bonus_false'] = '添加新的奖励积分操作失败！';
$_LANG['bonus_add_expire'] = '该奖励积分已经过期！';
$_LANG['bonus_use_expire'] = '该奖励积分已经过了使用期！';
...
$_LANG['merge'] = '合并';
$_LANG['notice_order_sn'] = '当两个订单不一致时，合并后的订单信息（如：支付方式、配送方式、包装、贺卡、奖励积分等）以第二个为准。';
$_LANG['subtotal'] = '小计';
...
/* 奖励积分详情 */
$_LANG['bonus_sn'] = '奖励积分序号';
$_LANG['bonus_name'] = '奖励积分名称';
$_LANG['bonus_amount'] = '奖励积分金额';
$_LANG['min_goods_amount'] = '最小订单金额';
$_LANG['bonus_end_date'] = '截至使用日期';
$_LANG['bonus_status'] = '奖励积分状态';
...
$_LANG['add_bonus'] = '添加奖励积分';

$_LANG['not_validated_alert'] = '您还没有通过邮件认证, 通过邮件验证后即可享受完整的购物体验';
?>
