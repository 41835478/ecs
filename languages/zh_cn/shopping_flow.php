...
$_LANG['invalid_bonus'] = "您选择的奖励积分并不存在。";
...
/*新加字段*/
$_LANG['flow_js']['zipcode_not_null'] = '邮政编码不能为空!';
...
$_LANG['validate_bonus'] = '验证奖励积分';
$_LANG['input_bonus_no'] = '或者输入奖励积分序列号';
$_LANG['select_bonus'] = '选择已有奖励积分';
$_LANG['bonus_sn_error'] = '该奖励积分序列号不正确';
$_LANG['bonus_min_amount_error'] = '订单商品金额没有达到使用该奖励积分的最低金额 %s';
$_LANG['bonus_is_ok'] = '该奖励积分序列号可以使用，可以抵扣 %s';
