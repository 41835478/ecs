...
function goods_list($is_delete, $real_goods=1)
{
    ...
    if ($result === false)
    {
        ...
        $sql = "SELECT auto_delivery, auto_delivery_number, shop_delivery, shop_delivery_number, goods_id, goods_name, goods_sn, shop_price, is_on_sale, is_best, is_new, is_hot, sort_order, goods_number, integral, " .
