 ...
 * ============================================================================
 * $Author: liubo $
 * $Id: flow.php 16426 2009-07-03 06:02:14Z liubo $
 */
...
elseif($_REQUEST['step'] == 'validate'){
    $content = $_LANG['not_validated'].
    "<a href='javascript:sendHashMail()' style='color:#006bd0;background:none;'>{$_LANG['resend_hash_mail']}</a>";
    $content .= "<br/>请不要关闭此页面";
    show_message($content,'通过验证后点击下一步',"flow.php?step=consignee",'info',false);  
}
