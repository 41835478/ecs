...
function get_goods_info($goods_id)
{
    ...
    {
        /* 生成外币价格 */
        $row['market_price_foreign'] = get_foreign_price($row['market_price']);
        $row['shop_price_foreign'] = get_foreign_price($row['shop_price']);
        /* 用户评论级别取整 */
        ...
        /* 生成外币价格 */
        $row['promote_price_foreign'] = get_foreign_price($promote_price);
    ...
    foreach ($res AS $row)
    {
        ...
        else
        {
            ...
            $arr['spe'][$row['attr_id']]['values'][] = array(
                                                        ...
                                                        'price_foreign' => get_foreign_price($row['attr_price']),
...
function get_goods_fittings($goods_list = array())
{
    ...
    while ($row = $GLOBALS['db']->fetchRow($res))
    {
        ...
        /* 外币价格 */
        $arr[$temp_index]['fittings_price_foreign'] = get_foreign_price($row['goods_price']);
        $arr[$temp_index]['shop_price_foreign'] = get_foreign_price($row['shop_price']);
